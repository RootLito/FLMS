...
<flux:card class="w-full h-full flex flex-col !p-0 overflow-hidden">
    ...
    <div class="p-8 flex-1 overflow-y-auto">
        ...
        @elseif ($step === 7)
            <div wire:key="step-view-7">
                <x-inspection.part-f :formData="$formData" :existingPhotos="$existingPhotos" />
            </div>
        @endif
    </div>
    ...
    <flux:modal name="confirm-update" class="md:max-w-lg">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Confirm Update</flux:heading>
                <flux:subheading>Are you sure you want to save changes to this report?</flux:subheading>
            </div>
